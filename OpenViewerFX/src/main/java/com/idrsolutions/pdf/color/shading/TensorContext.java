...
public class TensorContext implements PaintContext {
     ...
     * @param background
     */
    TensorContext(final AffineTransform xform, final GenericColorSpace shadingColorSpace, final ArrayList<Shape67> shapes, final float[] background, final float[][] mm, final PDFFunction[] function) {
